...
// 差別只在 CACHE_NAME 不同。因為這支檔案放在 kids-reward-tracker/ 目錄下註冊，
// scope 會自動限定在 /kids-reward-tracker/，不會跟根目錄的 sw.js 互相干擾。
// 這個小工具完全沒有外部 API 依賴（沒有匯率、沒有 Firebase），比根目錄那份更單純。

const CACHE_NAME = 'kids-reward-shell-v1';
